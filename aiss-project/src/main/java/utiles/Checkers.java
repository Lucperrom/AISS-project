 ...
 * 		Mensaje que se inluirá en la excepción lanzada
 * @param condicion
 * Expresión booleana que ha de cumplirse para que no se lance una excepción
...
/**
 * @param parametros Lista de parámetros para los que se quiere realizar una comparación de nulidad
