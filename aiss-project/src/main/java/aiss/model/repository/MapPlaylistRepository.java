...
public class MapPlaylistRepository implements PlaylistRepository{
	...
	public void init() {
		...
		songMap = new HashMap<String,Person>();
		
		// Create songs
		Person rollingInTheDeep=new Person();
		...
		Person losingMyReligion=new Person();
		...
		Person smellLikeTeenSpirit=new Person();
	...
	public void updateSong(Person s) {
		Person song = songMap.get(s.getId());
